...
export class DataImportComponent {
  ...
  @ViewChild('fileUpFail') public fileUpFail: ElementRef;
  @ViewChild('typeError') public typeError: ElementRef;
  @ViewChild('fileError') public fileError: ElementRef;
  ...
  private showFileWarn() {
    this.isShowDetailTable = false;
    setTimeout(() => {
      this.fileError.nativeElement.style.display = 'block';
    }, 0);
    setTimeout(() => {
      this.fileError.nativeElement.style.display = 'none';
    }, 2000);
    return;
  }

  private showSuccess(e: Response) {
    this.isShowDetailTable = false;
    if (e.status === 200) {
      setTimeout(() => {
      ...
      setTimeout(() => {
        this.fileUpFail.nativeElement.style.display = 'block';
      }, 0);
      setTimeout(() => {
        this.fileUpFail.nativeElement.style.display = 'none';
      }, 3000);
    }
    return;
  }
